...
import pytest
from app.services.grpc.chat_service import ChatService, get_user_id_from_context
...
def mock_document_service():
    doc_service = Mock()
    doc_service.get_chunks_by_ids = AsyncMock(return_value=[])
    return doc_service
...
class TestChatService:
    ...
    async def test_chat_success_with_documents(
        ...
        mock_document_service.get_chunks_by_ids = AsyncMock(return_value=[mock_chunk])
    ...
    async def test_chat_no_chunks_in_database(
        ...
        mock_document_service.get_chunks_by_ids = AsyncMock(return_value=[])
